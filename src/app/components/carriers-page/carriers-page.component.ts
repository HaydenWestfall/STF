  ...
  carriers: Carrier[] = [
    {
      ...
      logo: this.basePath + 'auto-owners.png',
      phone: '800-346-0346',
    ...
    },
    {
      ...
      logo: this.basePath + 'buckeye.png',
      phone: '937-778-5000',
      claims: '1-937-778-5022',
      payments:
        'https://consumer.buckeye-ins.com/account/login?ReturnUrl=%2F%3Futm_source%3Dbuckeye-ins.com%26utm_medium%3DcovidMakePayment%26utm_campaign%3Dpublic',
      claimsLink: 'https://www.buckeye-ins.com/claims',
    },
    {
      name: 'Celina Insurance Group',
      logo: this.basePath + 'celina.png',
      phone: '800-552-5181',
      claims: '800-231-2318',
    ...
    },
    {
      ...
      claimsLink:
        'https://www.donegalgroup.com/customer-services/claim-services',
    },
    {
      name: 'Encova Insurance',
      logo: this.basePath + 'encova.png',
      phone: '800-876-6642',
      claims: '800-876-8766',
    ...
    },
    {
      ...
      logo: this.basePath + 'foremost.png',
      phone: '800-527-3907',
      claims: '800-274-7865',
    ...
    },
    {
      ...
      logo: this.basePath + 'german-farmers.png',
      phone: '(419) 753-2575',
      claims: '',
      payments:
        'https://www.invoicecloud.com/portal/(S(dnnsum4a0hofd1jvbc43pdak))/2/Site2.aspx?G=d0076aa7-6ba4-436b-a555-4314c09deeed',
      claimsLink: 'https://gfmic.com/file-a-claim/',
    },
    {
      name: 'Grinnell Mutual Insurance Group',
      logo: this.basePath + 'grinnell.png',
      phone: '800-362-2041',
      claims: '877-467-2252',
    ...
    },
    {
      ...
      logo: this.basePath + 'hagerty.png',
      phone: '877-922-9701',
      claims: '800-385-0274',
    ...
    },
    {
      ...
      logo: this.basePath + 'hastings-mutual.png',
      phone: '(800) 442-8277',
      claims: '(800) 442-8277',
      payments:
